...
def slide_window_streaming():
    ...
    result_file = os.getcwd() + os.sep + "output" + os.sep + "table_slide_window_agg_streaming_004.csv"
    ...
    w3 = w2.on("row_time")
    w4 = w3.alias("w")
    # t1.window(Slide.over("10.minutes").every("1.minutes").on("row_time").alias("w")) #GroupWindowedTable
    print(type(w1))
    print(type(w2))
    print(type(w3))
    print(type(w4))
    #<class 'pyflink.table.window.SlideWithSize'>
    #<class 'pyflink.table.window.SlideWithSizeAndSlide'>
    #<class 'pyflink.table.window.SlideWithSizeAndSlideOnTime'>
    #<class 'pyflink.table.window.GroupWindow'>
     
    # Table window api
    # Table ------> GroupWindowedTable
    t2 = t1.window(w4) # GroupWindowedTable
    # table.window(GroupWindow)---------> GroupWindowedTable
    ...
    st_env.execute("slide window streaming")
    
    
if __name__ == '__main__':
    slide_window_streaming()
