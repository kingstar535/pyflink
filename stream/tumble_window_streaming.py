...
def tumble_window_streaming():
    ...
    result_file = os.getcwd() + os.sep + "output" + os.sep + "table_tumble_window_agg_streaming_004.csv"
    ...
    w1 = Tumble.over("2.minutes")
    w2 = w1.on("row_time")
    w3 = w2.alias("w")
    # t1.window(Tumble.over("2.minutes").on("row_time").alias("w")) #GroupWindowedTable
    print(type(w1))
    print(type(w2))
    print(type(w3))
    #<class 'pyflink.table.window.TumbleWithSize'>
    #<class 'pyflink.table.window.TumbleWithSizeOnTime'>
    ...
    st_env.execute("tumble window streaming")
     
    
if __name__ == '__main__':
    tumble_window_streaming()
